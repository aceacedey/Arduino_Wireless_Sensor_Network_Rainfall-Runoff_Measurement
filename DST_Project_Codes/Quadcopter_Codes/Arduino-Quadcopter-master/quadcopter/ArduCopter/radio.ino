...
//     g.rc_3.set_dead_zone(20); // ORIGINAL
    g.rc_3.set_dead_zone(137); // 20 - 137
    g.rc_4.set_dead_zone(30);
#else
//    g.rc_3.set_dead_zone(60); // ORIGINAL
    g.rc_3.set_dead_zone(137); // 60 - 137
    g.rc_4.set_dead_zone(80);
#endif
    //cliSerial->printf_P(PSTR("\nRC3_DEADZONE SET TO : %f\n"),(float)g.rc_3._dead_zone); 
...
static void read_radio()
{
    ...
    if (hal.rcin->valid_channels() > 0) {
        ...
        set_throttle_and_failsafe(periods[2]); // Calls g.rc_3.set_pwm(periods[2])
