...
static void captureImg(uint16_t wg, uint16_t hg){
  ...
  while (y--){
    x = wg/2;
    uint8_t *bStore = buff, *bSender = buff;      
    while (x--){
      // Average 2 bytes per pixel
      while ((PIND & 4));//wait for low
        *bStore++ = (PINC & 15) | (PIND & 240);
...
void setup(){
  ...
  // code for color bar testing
  //_delay_ms(100);  
  //wrReg(REG_COM7, 0b00000010);

  //_delay_ms(100);  
  //wrReg(0x70, 0b10000000);

  //_delay_ms(100);  
  //wrReg(0x71, 0b00000000);
}
