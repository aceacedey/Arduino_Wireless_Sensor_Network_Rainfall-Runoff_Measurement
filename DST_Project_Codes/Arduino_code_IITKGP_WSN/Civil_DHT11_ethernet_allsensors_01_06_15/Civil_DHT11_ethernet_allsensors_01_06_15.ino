    ...
    while (client.connected())
    {
      if (client.available())
      {
        ...
        if (c == '\n' && currentLineIsBlank)
        {
          ...
          client.println("<font face=Tahoma Size=3 color=Red><div align=center style=border:3px solid red> ");
          DateTime now = RTC.now();
          ...
          client.println("<font face=verdana size=5 color=red><P> WIND DIRECTION : ");
          client.println(strVals[angle]);
          client.println("</font></P>");
          ...
          client.println("<font face=verdana size=5 color=red><P> Current Generated by Wind-Turbine : ");
          client.println(mA * 1000);
          client.println(" mA");
          client.println("</font></P>");
          ...
          client.println("<font face=verdana size=5 color=red><P> RAINFALL in past 15 mintutes : ");
...
void windspeed()
{
  ...
  wind_sensorValue = analogRead(A0);//Analog 0
  ...
  if (currentMillis - previousMillis > interval)
  {
    ...
    Serial.print(",");
    wind_speed = (wind_sum * 2.4) / 5;//in Kph
    wind_temp = wind_sum;
    mA = amp_sum / count;
