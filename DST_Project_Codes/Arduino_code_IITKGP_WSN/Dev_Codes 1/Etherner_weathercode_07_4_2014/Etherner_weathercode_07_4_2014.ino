...
byte mac[] = { 0x90, 0xA2, 0xDA, 0x0E, 0x2E, 0xAF };
byte ip[] = {10,172,3,253}; // This is typically 10.0.0.x
...
//          while(client.connected())
          ...
          client.println("<P><img src=\"http://img52.imageshack.us/img52/4299/logovgn.png\" width=600 height=150 top=350px left=50px /></P>");
