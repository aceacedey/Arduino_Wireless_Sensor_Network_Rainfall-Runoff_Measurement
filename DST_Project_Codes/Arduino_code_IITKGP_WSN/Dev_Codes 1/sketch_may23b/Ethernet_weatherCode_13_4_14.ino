...
byte ip[] = {10,19,2,41}; // This is typically 10.0.0.x
...
//          {
             calcWindDir();
             client.println("<P> Wind Direction : </P>"); 
             client.println(strVals[x]);   
...
//              server.print(" Wind Direction : ");
//               server.print(strVals[x]);
//               server.print(" ----- ");
...
void calcHumidity()
{
  ...
  server.print(tempcel);
  server.print("C ");
  server.print(tempfar);
  server.print("F ");
  server.print(tempkel);
  server.print("K ");
  server.print(" ----- ");
  ...
  server.print(" DEW-FST : ");
  server.print(dewpfst);
  server.print(" ----- ");
