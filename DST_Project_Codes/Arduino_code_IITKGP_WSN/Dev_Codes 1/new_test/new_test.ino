/*
 ...
 Performs actions on Arduino and/or returns data from Arduino to a webbrowser request URL:
  - To turn on LED on pin 8, use web browser to visit your Arduino via: http://10.172.3.72/digitalWrite/7/1
  - To turn it off send: http://10.172.3.72/digitalWrite/7/0
  - To read analog0 value, send: http://10.172.3.72/analogRead/0
