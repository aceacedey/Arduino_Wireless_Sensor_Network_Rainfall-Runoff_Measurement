...
int wind_sum=0,rain_sum=0,rain_Value=0,rain_n=0,rain_m=0,wind_n=0,wind_temp=0,j=0,a;
    ...
    while (client.connected()) 
    {
      if (client.available()) 
      {
        ...
        if (c == '\n' && currentLineIsBlank) 
        {
          ...
          client.println("<font face=Tahoma Size=5 color=Red><h2 align=center>LOCATION 2 : SCHOOL OF WATER RESOURCES </font></h2>");
         ...
         rainfall();
          ...
          client.println("<font face=verdana size=5 color=red><P> Total RAINFALL since 26-03-2015 : ");
